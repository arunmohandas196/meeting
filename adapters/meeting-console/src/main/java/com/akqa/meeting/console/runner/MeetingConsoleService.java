package com.akqa.meeting.console.runner;
...
public class MeetingConsoleService implements CommandLineRunner {
  @Autowired private final CreateMeetingCalendarUseCase createMeetingCalendarService;
  @Autowired private final MeetingCalendarOutputPort meetingCalendarOutputPort;
